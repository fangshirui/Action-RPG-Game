...
func _directional_vector(vector: Vector2, n_directions: int, simmetry_angle2 := PI/2) -> Vector2:
	var angle := (vector.angle() + simmetry_angle2) / (PI / n_directions)
